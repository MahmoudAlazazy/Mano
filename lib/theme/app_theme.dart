...
/// Central color palette for the app. All widgets should reference these
/// constants rather than hardcoding hex values.
class AppColors {
  // ── Primary Palette ──────────────────────────────────────────
...
/// Standardised border-radius tokens. Use these instead of ad-hoc values
/// to keep corner rounding consistent across the app.
class AppRadius {
...
/// Standardised spacing tokens for padding, margin, and gap values.
class AppSpacing {
...
/// Pre-defined [TextStyle] constants covering the full type scale:
/// display → headline → body → label → button.
class AppTextStyles {
  // ── Display ──────────────────────────────────────────────────
...
/// Builds the app-wide [ThemeData]. All component themes (buttons, inputs,
/// cards, etc.) live here so styling is applied globally via the theme
/// rather than being repeated on individual widgets.
class AppTheme {
    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          minimumSize:      const Size(double.infinity, 54), // full-width, tall tap target
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        // Highlighted border when the field has focus.
      ...
      cardTheme: CardThemeData(
        ...
        margin: EdgeInsets.zero, // callers control spacing externally
      ),
      ...
      chipTheme: ChipThemeData(
        backgroundColor:     AppColors.surface,
        selectedColor:       AppColors.primary, // filled with primary when selected
      ...
      dividerTheme: const DividerThemeData(
        ...
        thickness: 1,
        space:     0, // no extra vertical space around the line
      ),
    );
  }
}
